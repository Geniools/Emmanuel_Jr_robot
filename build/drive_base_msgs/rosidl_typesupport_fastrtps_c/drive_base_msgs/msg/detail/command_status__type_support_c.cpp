  ...
  void * untyped_ros_message)
{
  ...
  _CommandStatus__ros_msg_type * ros_message = static_cast<_CommandStatus__ros_msg_type *>(untyped_ros_message);
  // Field name: stamp
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
{
  return max_serialized_size_drive_base_msgs__msg__CommandStatus(
    full_bounded, 0);
}
